...
public:
    ...
    enum StatusCode : byte {
        ...
        STATUS_TIMEOUT_T		,	// Timeout in communication.
...
protected:
    std::function<void(std::vector<uint8_t>&&)> m_callbackWrite;
    std::function<std::vector<uint8_t>(std::vector<uint8_t>&&)> m_callbackRead;
