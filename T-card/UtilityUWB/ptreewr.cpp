...
{
    std::string pathToParameter = std::string(m_parametersField) + "." + nameParameter + "." + m_typeField;
    std::string value = m_treeJson.get<std::string>(pathToParameter, std::string());
    return value;
}
